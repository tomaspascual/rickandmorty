...
public class Result {
    ...
    @JsonCreator
    public Result(@JsonProperty("id") Integer id,@JsonProperty("name") String name,@JsonProperty("status") String status,@JsonProperty("species") String species,@JsonProperty("type") String type,@JsonProperty("gender") String gender,@JsonProperty("origin") Origin origin,@JsonProperty("location") Location location,@JsonProperty("image") String image,@JsonProperty("episode") List<String> episode,@JsonProperty("url") String url,@JsonProperty("created") String created) {
        this.id = id;
        this.name = name;
        this.status = status;
